...
module b11 ( x_in, stbi, clock, reset, x_out, test_si, test_so, test_se );
  input [5:0] x_in;
  output [5:0] x_out;
  ...
  wire   [4:0] cont;
  wire   [7:1] cont1;
  wire   [5:4] add_101_carry;
  wire   [8:3] sub_97_carry;
  wire   [5:3] add_88_carry;
  wire   [8:3] sub_81_carry;
  wire   [6:1] sub_76_carry;
  wire   [6:2] add_73_carry;
  wire   [5:2] add_53_carry;
  assign test_so = x_out[5];
