...
/////////////////////////////////////////////////////////////
  ...
  output  canale[0], canale[1], canale[2], canale[3];
  ...
  wire    out_reg[0], out_reg[1], out_reg[2], out_reg[3], out_reg[4], out_reg[5], out_reg[6], out_reg[7];
  wire    next_bit[0], next_bit[1], next_bit[2], next_bit[3];
  wire    tx_conta[0], tx_conta[1], tx_conta[2], tx_conta[3], tx_conta[4], tx_conta[5], tx_conta[6], tx_conta[7], tx_conta[8], tx_conta[9];
  wire    add_291_carry[2], add_291_carry[3], add_291_carry[4], add_291_carry[5], add_291_carry[6], add_291_carry[7], add_291_carry[8], add_291_carry[9];
